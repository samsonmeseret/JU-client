...
const Hero = () => {
  return (
    <>
      <Navbar />
      <div className="relative isolate px-6  lg:px-8 mt-[-50px]">
        <div
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-48">
          ...
          <div className="text-center">
            <h1 className="text-2xl font-bold tracking-tight text-gray-800 sm:text-6xl">
              Smart Employee and Academic activity Management System
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Jimma University is committed to Engaging in Core Functions of
              Innovative Teaching, Research and Community Services Through its
              Cherished and Innovative Community Based Education (CBE).
            </p>
