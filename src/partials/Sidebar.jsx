        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
                          ...
                          <div className="flex items-center">
                            <AiOutlineDashboard
                              className={`fill-current text-slate-400 ${
                                pathname === "/dashboard" && "text-indigo-300"
                              }`}
                            />
              ...
              <SidebarLinkGroup
                activecondition={
                  pathname === "/" || pathname.includes("department")
                }
              >
                {(handleClick, open) => {
                  return (
                  ...
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-slate-200 hover:text-white truncate transition duration-150 ${
                          pathname.includes("leaves") && "hover:text-slate-200"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded
              ...
              {/* on Education */}
              <SidebarLinkGroup
                activecondition={pathname.includes("on-education")}
              >
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-slate-200 hover:text-white truncate transition duration-150 ${
                          pathname.includes("on-education") &&
                          "hover:text-slate-200"
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
