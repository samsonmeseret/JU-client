      ...
      const formik = useFormik({
            ...
            validationSchema: Yup.object({
                  ...
                  from: Yup.string().required(
                        "please select the leave starting date"
                  ),
                  to: Yup.string().required(
                        "please select the leave ending date"
                  ),
                  totalDay: Yup.string().required(
                        "please enter the total day in number"
                  ),
                  reason: Yup.string().required(
                        "please enter the reason for a leave"
                  ),
                                                ...
                                                <div className="space-y-4">
                                                      ...
                                                      <div>
                                                            ...
                                                            >
                                                                  ...
                                                                  <>
                                                                        {["Annual Leave", "Sick Leave", "Study Leave", "Compassionate Leave", "Maternity Leave", "Paternity Leave", "Domestic Violence Leave"].map((lv, i) => {
                                                                              return (
